...
export const ActionGrid = ({ onAction, isTimerRunning }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-6">
            {!isTimerRunning && (
                // Timer Required Notice
                <div className="bg-gradient-to-r from-amber-500/20 to-orange-600/20 border-2 border-amber-500/30 rounded-2xl p-6 mb-6">
            ...
            <div className={`grid grid-cols-2 gap-4 transition-all duration-300 ${
                ...
                <button 
                    ...
                    disabled={!isTimerRunning}
                    className="group relative bg-gradient-to-br from-amber-500/20 to-orange-600/20 hover:from-amber-500/30 hover:to-orange-600/30 border-2 border-amber-500/30 hover:border-amber-500/50 rounded-2xl p-6 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl hover:shadow-amber-500/10 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    <div className="flex flex-col items-center space-y-3">
